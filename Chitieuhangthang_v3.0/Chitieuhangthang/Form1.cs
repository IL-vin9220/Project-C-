...
namespace Chitieuhangthang
{
    public partial class Form1 : Form
    {
        ...
        private void btnMaunen_Click(object sender, EventArgs e)
        {
            ...
            if (color.ShowDialog() == DialogResult.OK)
            {
                ...
                if(label2.ForeColor != color.Color)
                {
                    ...
                    this.label8.BackColor = Color.FromArgb(255, 255, 255);
                    this.label9.BackColor = Color.FromArgb(255, 255, 255);
                    this.checkSanPham.BackColor = Color.FromArgb(255, 255, 255);
                    this.checkGiaMua.BackColor = Color.FromArgb(255, 255, 255);
                    this.checkNgay.BackColor = Color.FromArgb(255, 255, 255);
                    this.checkToanBo.BackColor = Color.FromArgb(255, 255, 255);
                    this.checkKhoang.BackColor = Color.FromArgb(255, 255, 255);
                }
                else
                {
        ...
        private void xemThôngTinToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                trocap = (int.Parse(ds[0]) + int.Parse(tiendu)).ToString();
        ...
        private void btnHinhnen_Click(object sender, EventArgs e)
        {
            ...
            if(dr == DialogResult.OK)
            {
                ...
                if(TypeDisplay == 1)
                {
                    ...
                    this.tabPage2.BackgroundImageLayout = ImageLayout.Center;
                ...
                else if(TypeDisplay == 2)
                {
                    ...
                    this.tabPage2.BackgroundImageLayout = ImageLayout.Tile;
                ...
                else if(TypeDisplay == 3)
                {
                    ...
                    this.tabPage2.BackgroundImageLayout = ImageLayout.Zoom;
        ...
        // bỏ tích ở toàn bộ hoặc khoảng
        // bỏ tích ở toàn bộ
        private void checkToanBo_CheckedChanged(object sender, EventArgs e)
        {
            if (checkToanBo.Checked == true)
                checkKhoang.Checked = false;
            else
                checkKhoang.Checked = true;
        }

        // bỏ tích ở khoảng
        private void checkKhoang_CheckedChanged(object sender, EventArgs e)
        {
            if (checkKhoang.Checked == true)
                checkToanBo.Checked = false;
            else
                checkToanBo.Checked = true;
        }

        // chỉ được tích ở 1 trong 3 checkbox: Sản phẩm, Giá mua, Ngày
        // Tích ở Sản phẩm
        private void checkSanPham_CheckedChanged(object sender, EventArgs e)
        {
            if(checkSanPham.Checked == true)
            {
                checkGiaMua.Checked = false;
                checkNgay.Checked = false;
            }
        }

        // Tích ở Giá mua
        private void checkGiaMua_CheckedChanged(object sender, EventArgs e)
        {
            if(checkGiaMua.Checked == true)
            {
                checkSanPham.Checked = false;
                checkNgay.Checked = false;
            }
        }
